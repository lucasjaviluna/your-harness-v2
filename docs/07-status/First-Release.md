...
4. Agregar CI/CD mínimo: build, tests, lint, validación documental y empaquetado — workflow implementado para Node 20/22; queda observar la primera ejecución remota.
