...
| Test suite | Early | Seventeen focused tests cover context projection, Core smoke flows, Runtime composition/boundary, execution environment, OpenSpec read-only projection and Pi adapter; broad coverage is pending. |
