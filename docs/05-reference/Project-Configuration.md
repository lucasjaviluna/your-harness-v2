...
- Every `allowedPaths` entry must remain inside the execution workspace and relative entries are resolved against that workspace root by the runtime boundary.
