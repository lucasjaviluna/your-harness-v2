...
export const changeApplyTransitionSchema = z.object({
  ...
  fromStatus: z.enum(["approved", "apply-ready", "applying", "materialized", "apply-failed", "recovery-required"]).optional(),
  toStatus: z.enum(["approved", "apply-ready", "applying", "materialized", "apply-failed", "recovery-required"]),
