...
export const changeMaterializationAuditSchema = z.object({
  id: z.string().min(1), attemptId: z.string().min(1), idempotencyKey: z.string().min(1), retryOfAttemptId: z.string().optional(), recoveryOfAttemptId: z.string().optional(), handoffId: z.string().min(1), changeId: z.string().min(1), providerId: z.string().min(1),
